...
ICALL(BTLS_X509_1, "mono_btls_x509_add_reject_object", mono_btls_x509_add_reject_object)
ICALL(BTLS_X509_2, "mono_btls_x509_add_trust_object", mono_btls_x509_add_trust_object)
ICALL(BTLS_X509_3, "mono_btls_x509_cmp", mono_btls_x509_cmp)
ICALL(BTLS_X509_4, "mono_btls_x509_dup", mono_btls_x509_dup)
ICALL(BTLS_X509_5, "mono_btls_x509_free", mono_btls_x509_free)
ICALL(BTLS_X509_6, "mono_btls_x509_from_data", mono_btls_x509_from_data)
ICALL(BTLS_X509_7, "mono_btls_x509_get_hash", mono_btls_x509_get_hash)
ICALL(BTLS_X509_8, "mono_btls_x509_get_issuer_name", mono_btls_x509_get_issuer_name)
ICALL(BTLS_X509_9, "mono_btls_x509_get_issuer_name_string", mono_btls_x509_get_issuer_name_string)
ICALL(BTLS_X509_10, "mono_btls_x509_get_not_after", mono_btls_x509_get_not_after)
ICALL(BTLS_X509_11, "mono_btls_x509_get_not_before", mono_btls_x509_get_not_before)
ICALL(BTLS_X509_12, "mono_btls_x509_get_pubkey", mono_btls_x509_get_pubkey)
ICALL(BTLS_X509_13, "mono_btls_x509_get_public_key", mono_btls_x509_get_public_key)
ICALL(BTLS_X509_14, "mono_btls_x509_get_public_key_algorithm", mono_btls_x509_get_public_key_algorithm)
ICALL(BTLS_X509_15, "mono_btls_x509_get_public_key_asn1", mono_btls_x509_get_public_key_asn1)
ICALL(BTLS_X509_16, "mono_btls_x509_get_public_key_parameters", mono_btls_x509_get_public_key_parameters)
ICALL(BTLS_X509_17, "mono_btls_x509_get_raw_data", mono_btls_x509_get_raw_data)
ICALL(BTLS_X509_18, "mono_btls_x509_get_serial_number", mono_btls_x509_get_serial_number)
ICALL(BTLS_X509_19, "mono_btls_x509_get_signature_algorithm", mono_btls_x509_get_signature_algorithm)
ICALL(BTLS_X509_20, "mono_btls_x509_get_subject_key_identifier", mono_btls_x509_get_subject_key_identifier)
ICALL(BTLS_X509_21, "mono_btls_x509_get_subject_name", mono_btls_x509_get_subject_name)
ICALL(BTLS_X509_22, "mono_btls_x509_get_subject_name_string", mono_btls_x509_get_subject_name_string)
ICALL(BTLS_X509_23, "mono_btls_x509_get_version", mono_btls_x509_get_version)
ICALL(BTLS_X509_23a, "mono_btls_x509_martin_test", mono_btls_x509_martin_test)
ICALL(BTLS_X509_24, "mono_btls_x509_print", mono_btls_x509_print)
ICALL(BTLS_X509_25, "mono_btls_x509_up_ref", mono_btls_x509_up_ref)
