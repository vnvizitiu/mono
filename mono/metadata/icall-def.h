...
ICALL(BTLS_SSL_2, "mono_btls_ssl_close", mono_btls_ssl_close)
ICALL(BTLS_SSL_3, "mono_btls_ssl_connect", mono_btls_ssl_connect)
ICALL(BTLS_SSL_4, "mono_btls_ssl_destroy", mono_btls_ssl_destroy)
ICALL(BTLS_SSL_5, "mono_btls_ssl_get_cipher", mono_btls_ssl_get_cipher)
ICALL(BTLS_SSL_6, "mono_btls_ssl_get_ciphers", mono_btls_ssl_get_ciphers)
ICALL(BTLS_SSL_7, "mono_btls_ssl_get_error", mono_btls_ssl_get_error)
ICALL(BTLS_SSL_8, "mono_btls_ssl_get_peer_certificate", mono_btls_ssl_get_peer_certificate)
ICALL(BTLS_SSL_9, "mono_btls_ssl_get_version", mono_btls_ssl_get_version)
ICALL(BTLS_SSL_10, "mono_btls_ssl_handshake", mono_btls_ssl_handshake)
ICALL(BTLS_SSL_11, "mono_btls_ssl_new", mono_btls_ssl_new)
ICALL(BTLS_SSL_12, "mono_btls_ssl_print_errors_cb", mono_btls_ssl_print_errors_cb)
ICALL(BTLS_SSL_13, "mono_btls_ssl_read", mono_btls_ssl_read)
ICALL(BTLS_SSL_14, "mono_btls_ssl_set_bio", mono_btls_ssl_set_bio)
ICALL(BTLS_SSL_15, "mono_btls_ssl_set_cipher_list", mono_btls_ssl_set_cipher_list)
ICALL(BTLS_SSL_16, "mono_btls_ssl_set_max_version", mono_btls_ssl_set_max_version)
ICALL(BTLS_SSL_17, "mono_btls_ssl_set_min_version", mono_btls_ssl_set_min_version)
ICALL(BTLS_SSL_18, "mono_btls_ssl_test", mono_btls_ssl_test)
ICALL(BTLS_SSL_19, "mono_btls_ssl_use_certificate", mono_btls_ssl_use_certificate)
ICALL(BTLS_SSL_20, "mono_btls_ssl_use_private_key", mono_btls_ssl_use_private_key)
ICALL(BTLS_SSL_21, "mono_btls_ssl_write", mono_btls_ssl_write)
...
ICALL(BTLS_SSL_CTX_4, "mono_btls_ssl_ctx_is_cipher_supported", mono_btls_ssl_ctx_is_cipher_supported)
ICALL(BTLS_SSL_CTX_5, "mono_btls_ssl_ctx_is_debug_enabled", mono_btls_ssl_ctx_is_debug_enabled)
ICALL(BTLS_SSL_CTX_6, "mono_btls_ssl_ctx_new", mono_btls_ssl_ctx_new)
ICALL(BTLS_SSL_CTX_7, "mono_btls_ssl_ctx_peek_store", mono_btls_ssl_ctx_peek_store)
ICALL(BTLS_SSL_CTX_8, "mono_btls_ssl_ctx_set_cert_verify_callback", mono_btls_ssl_ctx_set_cert_verify_callback)
ICALL(BTLS_SSL_CTX_9, "mono_btls_ssl_ctx_set_ciphers", mono_btls_ssl_ctx_set_ciphers)
ICALL(BTLS_SSL_CTX_10, "mono_btls_ssl_ctx_set_debug_bio", mono_btls_ssl_ctx_set_debug_bio)
ICALL(BTLS_SSL_CTX_11, "mono_btls_ssl_ctx_set_max_version", mono_btls_ssl_ctx_set_max_version)
ICALL(BTLS_SSL_CTX_12, "mono_btls_ssl_ctx_set_min_version", mono_btls_ssl_ctx_set_min_version)
ICALL(BTLS_SSL_CTX_13, "mono_btls_ssl_ctx_up_ref", mono_btls_ssl_ctx_up_ref)

ICALL_TYPE(BTLS_X509, "Mono.Btls.MonoBtlsX509", BTLS_X509_1)
ICALL(BTLS_X509_1, "mono_btls_x509_cmp", mono_btls_x509_cmp)
ICALL(BTLS_X509_2, "mono_btls_x509_free", mono_btls_x509_free)
ICALL(BTLS_X509_3, "mono_btls_x509_from_data", mono_btls_x509_from_data)
ICALL(BTLS_X509_4, "mono_btls_x509_get_hash", mono_btls_x509_get_hash)
ICALL(BTLS_X509_5, "mono_btls_x509_get_issuer_name", mono_btls_x509_get_issuer_name)
ICALL(BTLS_X509_6, "mono_btls_x509_get_issuer_name_string", mono_btls_x509_get_issuer_name_string)
ICALL(BTLS_X509_7, "mono_btls_x509_get_not_after", mono_btls_x509_get_not_after)
ICALL(BTLS_X509_8, "mono_btls_x509_get_not_before", mono_btls_x509_get_not_before)
ICALL(BTLS_X509_9, "mono_btls_x509_get_pubkey", mono_btls_x509_get_pubkey)
ICALL(BTLS_X509_10, "mono_btls_x509_get_public_key", mono_btls_x509_get_public_key)
ICALL(BTLS_X509_11, "mono_btls_x509_get_public_key_algorithm", mono_btls_x509_get_public_key_algorithm)
ICALL(BTLS_X509_12, "mono_btls_x509_get_public_key_asn1", mono_btls_x509_get_public_key_asn1)
ICALL(BTLS_X509_13, "mono_btls_x509_get_public_key_parameters", mono_btls_x509_get_public_key_parameters)
ICALL(BTLS_X509_14, "mono_btls_x509_get_raw_data", mono_btls_x509_get_raw_data)
ICALL(BTLS_X509_15, "mono_btls_x509_get_serial_number", mono_btls_x509_get_serial_number)
ICALL(BTLS_X509_16, "mono_btls_x509_get_signature_algorithm", mono_btls_x509_get_signature_algorithm)
ICALL(BTLS_X509_17, "mono_btls_x509_get_subject_name", mono_btls_x509_get_subject_name)
ICALL(BTLS_X509_18, "mono_btls_x509_get_subject_name_string", mono_btls_x509_get_subject_name_string)
ICALL(BTLS_X509_19, "mono_btls_x509_get_version", mono_btls_x509_get_version)
ICALL(BTLS_X509_20, "mono_btls_x509_up_ref", mono_btls_x509_up_ref)
...
ICALL(BTLS_X509_LOOKUP_2, "mono_btls_x509_lookup_by_fingerprint", mono_btls_x509_lookup_by_fingerprint)
ICALL(BTLS_X509_LOOKUP_3, "mono_btls_x509_lookup_by_subject", mono_btls_x509_lookup_by_subject)
ICALL(BTLS_X509_LOOKUP_4, "mono_btls_x509_lookup_free", mono_btls_x509_lookup_free)
ICALL(BTLS_X509_LOOKUP_5, "mono_btls_x509_lookup_init", mono_btls_x509_lookup_init)
ICALL(BTLS_X509_LOOKUP_6, "mono_btls_x509_lookup_load_file", mono_btls_x509_lookup_load_file)
ICALL(BTLS_X509_LOOKUP_7, "mono_btls_x509_lookup_new", mono_btls_x509_lookup_new)
ICALL(BTLS_X509_LOOKUP_8, "mono_btls_x509_lookup_shutdown", mono_btls_x509_lookup_shutdown)
ICALL(BTLS_X509_LOOKUP_9, "mono_btls_x509_lookup_up_ref", mono_btls_x509_lookup_up_ref)

ICALL_TYPE(BTLS_X509_LOOKUP_METHOD, "Mono.Btls.MonoBtlsX509LookupMethod", BTLS_X509_LOOKUP_METHOD_1)
ICALL(BTLS_X509_LOOKUP_METHOD_1, "mono_btls_x509_lookup_method_by_file", mono_btls_x509_lookup_method_by_file)
ICALL(BTLS_X509_LOOKUP_METHOD_2, "mono_btls_x509_lookup_method_by_hash_dir", mono_btls_x509_lookup_method_by_hash_dir)
ICALL(BTLS_X509_LOOKUP_METHOD_3, "mono_btls_x509_lookup_method_free", mono_btls_x509_lookup_method_free)
ICALL(BTLS_X509_LOOKUP_METHOD_4, "mono_btls_x509_lookup_method_new", mono_btls_x509_lookup_method_new)
ICALL(BTLS_X509_LOOKUP_METHOD_5, "mono_btls_x509_lookup_method_peek_method", mono_btls_x509_lookup_method_peek_method)
ICALL(BTLS_X509_LOOKUP_METHOD_6, "mono_btls_x509_lookup_method_up_ref", mono_btls_x509_lookup_method_up_ref)

ICALL_TYPE(BTLS_X509_LOOKUP_METHOD_MONO, "Mono.Btls.MonoBtlsX509LookupMethodMono", BTLS_X509_LOOKUP_METHOD_MONO_1)
ICALL(BTLS_X509_LOOKUP_METHOD_MONO_1, "mono_btls_x509_lookup_method_mono_init", mono_btls_x509_lookup_method_mono_init)
ICALL(BTLS_X509_LOOKUP_METHOD_MONO_2, "mono_btls_x509_lookup_method_mono_new", mono_btls_x509_lookup_method_mono_new)
ICALL(BTLS_X509_LOOKUP_METHOD_MONO_3, "mono_btls_x509_lookup_method_mono_set_by_fingerprint_func", mono_btls_x509_lookup_method_mono_set_by_fingerprint_func)
ICALL(BTLS_X509_LOOKUP_METHOD_MONO_4, "mono_btls_x509_lookup_method_mono_set_by_subject_func", mono_btls_x509_lookup_method_mono_set_by_subject_func)
...
ICALL(BTLS_X509_STORE_6, "mono_btls_x509_store_get_verify_param", mono_btls_x509_store_get_verify_param)
ICALL(BTLS_X509_STORE_7, "mono_btls_x509_store_load_locations", mono_btls_x509_store_load_locations)
ICALL(BTLS_X509_STORE_8, "mono_btls_x509_store_new", mono_btls_x509_store_new)
ICALL(BTLS_X509_STORE_9, "mono_btls_x509_store_peek_store", mono_btls_x509_store_peek_store)
ICALL(BTLS_X509_STORE_10, "mono_btls_x509_store_set_default_paths", mono_btls_x509_store_set_default_paths)
ICALL(BTLS_X509_STORE_11, "mono_btls_x509_store_up_ref", mono_btls_x509_store_up_ref)
...
ICALL(BTLS_X509_STORE_CTX_3, "mono_btls_x509_store_ctx_get_chain", mono_btls_x509_store_ctx_get_chain)
ICALL(BTLS_X509_STORE_CTX_4, "mono_btls_x509_store_ctx_get_current_cert", mono_btls_x509_store_ctx_get_current_cert)
ICALL(BTLS_X509_STORE_CTX_5, "mono_btls_x509_store_ctx_get_current_issuer", mono_btls_x509_store_ctx_get_current_issuer)
ICALL(BTLS_X509_STORE_CTX_6, "mono_btls_x509_store_ctx_get_error", mono_btls_x509_store_ctx_get_error)
ICALL(BTLS_X509_STORE_CTX_7, "mono_btls_x509_store_ctx_get_error_depth", mono_btls_x509_store_ctx_get_error_depth)
ICALL(BTLS_X509_STORE_CTX_8, "mono_btls_x509_store_ctx_init", mono_btls_x509_store_ctx_init)
ICALL(BTLS_X509_STORE_CTX_9, "mono_btls_x509_store_ctx_new", mono_btls_x509_store_ctx_new)
ICALL(BTLS_X509_STORE_CTX_10, "mono_btls_x509_store_ctx_set_param", mono_btls_x509_store_ctx_set_param)
ICALL(BTLS_X509_STORE_CTX_11, "mono_btls_x509_store_ctx_test", mono_btls_x509_store_ctx_test)
ICALL(BTLS_X509_STORE_CTX_12, "mono_btls_x509_store_ctx_up_ref", mono_btls_x509_store_ctx_up_ref)
ICALL(BTLS_X509_STORE_CTX_13, "mono_btls_x509_store_ctx_verify_cert", mono_btls_x509_store_ctx_verify_cert)
