...
ICALL(BTLS_SSL_18, "mono_btls_ssl_set_max_version", mono_btls_ssl_set_max_version)
ICALL(BTLS_SSL_19, "mono_btls_ssl_set_min_version", mono_btls_ssl_set_min_version)
ICALL(BTLS_SSL_20, "mono_btls_ssl_set_servername", mono_btls_ssl_set_servername)
ICALL(BTLS_SSL_21, "mono_btls_ssl_test", mono_btls_ssl_test)
ICALL(BTLS_SSL_22, "mono_btls_ssl_use_certificate", mono_btls_ssl_use_certificate)
ICALL(BTLS_SSL_23, "mono_btls_ssl_use_private_key", mono_btls_ssl_use_private_key)
ICALL(BTLS_SSL_24, "mono_btls_ssl_write", mono_btls_ssl_write)
