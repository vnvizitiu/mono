...
ICALL(BTLS_SSL_8, "mono_btls_ssl_get_version", mono_btls_ssl_get_version)
ICALL(BTLS_SSL_9, "mono_btls_ssl_handshake", mono_btls_ssl_handshake)
ICALL(BTLS_SSL_10, "mono_btls_ssl_new", mono_btls_ssl_new)
ICALL(BTLS_SSL_11, "mono_btls_ssl_print_errors_cb", mono_btls_ssl_print_errors_cb)
ICALL(BTLS_SSL_12, "mono_btls_ssl_read", mono_btls_ssl_read)
ICALL(BTLS_SSL_13, "mono_btls_ssl_set_bio", mono_btls_ssl_set_bio)
ICALL(BTLS_SSL_14, "mono_btls_ssl_set_cipher_list", mono_btls_ssl_set_cipher_list)
ICALL(BTLS_SSL_15, "mono_btls_ssl_set_max_version", mono_btls_ssl_set_max_version)
ICALL(BTLS_SSL_16, "mono_btls_ssl_set_min_version", mono_btls_ssl_set_min_version)
ICALL(BTLS_SSL_17, "mono_btls_ssl_test", mono_btls_ssl_test)
ICALL(BTLS_SSL_18, "mono_btls_ssl_use_certificate", mono_btls_ssl_use_certificate)
ICALL(BTLS_SSL_19, "mono_btls_ssl_use_private_key", mono_btls_ssl_use_private_key)
ICALL(BTLS_SSL_20, "mono_btls_ssl_write", mono_btls_ssl_write)
