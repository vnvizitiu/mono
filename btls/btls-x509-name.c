...
nid2mono (int nid)
{
	...
	case NID_countryName:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_COUNTRY_NAME;
	case NID_organizationName:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_ORGANIZATION_NAME;
	case NID_organizationalUnitName:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_ORGANIZATIONAL_UNIT_NAME;
	case NID_commonName:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_COMMON_NAME;
	case NID_localityName:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_LOCALITY_NAME;
	case NID_stateOrProvinceName:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_STATE_OR_PROVINCE_NAME;
	case NID_streetAddress:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_STREET_ADDRESS;
	case NID_serialNumber:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_SERIAL_NUMBER;
	case NID_domainComponent:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_DOMAIN_COMPONENT;
	case NID_userId:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_USER_ID;
	case NID_dnQualifier:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_DN_QUALIFIER;
	case NID_title:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_TITLE;
	case NID_surname:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_SURNAME;
	case NID_givenName:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_GIVEN_NAME;
	case NID_initials:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_INITIAL;
	default:
		return NATIVE_BORING_X509_NAME_ENTRY_TYPE_UNKNOWN;
	}
}
